...
const Contactemailjs = () => {
  ...
  const handleChange = (e) =>{  const { target } = e;
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Form values:", form); // Verifica si los valores del formulario se capturan correctamente
  
    emailjs
      .send(
        'service_lzad53s', // Mi Service ID
        'template_172qri5', // Mi Template ID
        {
          from_name: form.name,
          to_name: 'Agustín Maseda',
          from_email: form.email,
          to_email: 'agusmaseda05@gmail.com',
          message: form.message,
        },
        'PPEqZjrkWHoLTBijD' // Mi Public Key
      )
      .then(
        () => {
          setLoading(false);
    ...
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <label className="flex flex-col">
            <span className="text-white font-medium mb-4">Tu Mail</span>
            <input 
              type="email"
              name="email"
              value={form.email}
